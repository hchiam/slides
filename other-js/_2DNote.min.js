...
var _2DNote = {
  ...
  setAs2DArea: function (e, t, n) {
    ...
    i.addEventListener("mousedown", this.play.bind(this)),
      i.addEventListener("mouseup", this.stop.bind(this)),
      i.addEventListener("mousemove", this.update.bind(this)),
      i.addEventListener("touchstart", this.play.bind(this)),
      i.addEventListener("touchend", this.stop.bind(this)),
      i.addEventListener("touchmove", this.update.bind(this)),
      n && this.setupExitedViewDetection(i);
  },
  play: function (e, t) {
    ...
    a.connect(this.audioContext.destination),
      (a.gain.value = isNaN(i) ? 0.5 : i);
    var r = this.audioContext.createOscillator();
    (r.type = "sine"), (r.frequency.value = isNaN(n) ? 400 : n), r.connect(a);
    var s = this.audioContext.createStereoPanner();
    o && (s.pan.value = o),
      a.connect(s),
      s.connect(this.audioContext.destination),
      r.start(),
      (this.note = { oscillator: r, volumeSetup: a, panner: s });
  },
  update: function (e, t) {
    if (this.note) {
      var n = this.getFrequency(e),
        i = this.getVolume(e),
        o = this.getPan(e);
      (this.note.volumeSetup.gain.value = i),
        (this.note.oscillator.frequency.value = n),
        (this.note.panner.pan.value = o),
        t
          ? t(i, n, o)
          : this.callbackUponUpdate && this.callbackUponUpdate(i, n, o);
    }
  },
  stop: function () {
    null != this.note &&
  ...
  normalize: function (e, t, n) {
    var i = t[0],
      ...
      r = n[1],
      s = ((r - a) / (o - i)) * (e - i) + a;
    return Math.min(Math.max(s, a), r);
  },
  copy: function () {
    return (function e(t) {
      ...
      for (var o in t)
        t.hasOwnProperty(o) &&
          ("audioContext" === o
            ? (i.audioContext = new AudioContext())
            : (i[o] = e(t[o])));
      return i;
    })(this);
  },
