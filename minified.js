    ...
    (function (e) {
      e.addEventListener(
        ...
        function (n) {
          ...
          r && ((i && !i.startOffset) || (!i && !e.startedTyping))
            ? ((e.detectAsClickToEdit = !1),
              (e.contentEditable = !1),
              (function (e, n) {
                var r = e.offsetLeft,
...
(window.Firebase = {
  ...
  splitStringToFitInFirestoreFieldValue: function (e) {
    var t = Memory.getStringAsBytesArray(e).map(
  ...
  (window.Images = {
    ...
    createImage: function (e = Slides.currentSlide, t, n, r, i, o, a) {
...
(window.Memory = {
  ...
  deleteElementsOnSlide: function (e) {
    var t = memory.slides[e].texts,
      ...
      r = Object.keys(t).map((t) => memory.slides[e].texts[t].id),
      i = Object.keys(n).map((t) => memory.slides[e].images[t].id);
    r.forEach((e) => {
